...
// +---------------------------------------------------------------------+
//
// $Id: counter.php,v 1.1 2003/03/30 17:56:56 cbleek Exp $
//

require_once "prepend.inc";
require_once OPENHR_LIB.'/Track.php';

$parameters['job_id']       = isset($_GET['key'])          ? $_GET['key']              : 0;
$parameters['what']         = isset($_GET['what'])         ? $_GET['what']             : "";


Track::pageview($parameters);
